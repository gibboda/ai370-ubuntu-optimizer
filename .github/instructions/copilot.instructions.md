...
GitHub Copilot is a specialist/escalation resource in this repository, not
the default implementation agent. [`../../AGENTS.md`](../../AGENTS.md) is
authoritative for shared agent roles, escalation, cost policy, architecture,
testing, naming, and change discipline. Do not restate or override that
policy here.
...
scope: coding agent, pull-request review, or Projects MCP. Prefer
GitHub-native OAuth for the official hosted GitHub MCP endpoint; do not
