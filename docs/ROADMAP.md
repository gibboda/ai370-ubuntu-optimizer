...
| S5-M6 | `scripts/validate-commit-subject.sh`, `scripts/validate-pr-title.sh`, `scripts/github_label_policy.py`, `.github/label-policy.json`, `.github/grok/`, `.github/antigravity/` | Release-policy validation, GitHub label automation, and local Grok Build / Antigravity CLI advisory-review docs |
