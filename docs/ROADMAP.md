...
| S5-M6 | `scripts/validate-commit-subject.sh`, `scripts/validate-pr-title.sh`, `scripts/github_label_policy.py`, `scripts/external-agent`, `.github/label-policy.json`, `.github/grok/`, `.github/antigravity/` | Release-policy validation, GitHub label automation, local Grok Build / Antigravity CLI advisory-review docs, and the vendor-neutral local external-agent wrapper |
