...
- Align compatibility script labels, JSON `milestone` fields, and user docs
  with ROADMAP owners (S3-M1 models, S3-M4/S3-M5/S3-M6 runtimes, S4-M1/S4-M3
  applications). Compatibility wrappers emit deprecation warnings.
