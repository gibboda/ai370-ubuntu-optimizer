...
- **architecture:** Sync current-version stamps to `2.2.0` in ROADMAP,
  ...
  GitHub issues were filed as `#209`–`#239`. Historical publisher
  landings (`0.20.0` / `0.21.0` / `0.25.0`) remain history; `1.0.0`
  and `2.2.0` are not R1.
...
* **agents:** Add bounded provider-capacity failover ([#296](https://github.com/gibboda/ai370-ubuntu-optimizer/issues/296)) ([7bb69cd](https://github.com/gibboda/ai370-ubuntu-optimizer/commit/7bb69cdf3652050c8b63361b7429248acb9bcb22))
