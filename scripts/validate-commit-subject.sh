...
main() {
  ...
  allowed_scopes='audit|baseline|amd|ai-stack|rocm|npu|acceleration|comfyui|config|architecture|agents|governance|workflows|vscode|release|deps|stage|stage1|stage2|stage3|stage4|stage5|tier|tier1|tier2'
  ...
  if [[ ! "$subject" =~ $pattern ]]; then
    ...
    echo "[ERROR] Allowed scopes: audit, baseline, amd, ai-stack, rocm, npu, acceleration, comfyui, config, architecture, agents, governance, workflows, vscode, release, deps, stage, stage1, stage2, stage3, stage4, stage5, tier (deprecated), tier1 (deprecated), tier2 (deprecated)" >&2
